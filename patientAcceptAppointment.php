...
<form action="patientAcceptDeclineAppointment.php" method="post">
  <label for="appointment" style="color:white">Accept/Decline Appointment:</label>
  <select id="appointmentStatus" name="appointmentStatus" value="submit">
    <option value="accept" selected>Accept</option>
    <option value="decline">Decline</option>
    <input type="hidden" name=appointment_id value="<?php echo $appointment_id ?>" style="width: 200px;" readonly />
    <input type="hidden" name=patientId value="<?php echo $patientId ?>" style="width: 200px;" readonly />
  </select>
  <br>
  <tr>

   <input type="submit" value="submit" class= "btn btn btn-secondary btn-lg">
  </tr>
</form>
